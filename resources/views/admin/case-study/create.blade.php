...
<html>
    <head>
        ...
        <title>Admin Simulasi CGAA | Tambah Soal Studi Kasus</title>
        <!-- Bootstrap CSS -->
        ...
        <div class="d-flex">
            ...
            <main class="d-flex flex-column overflow-auto border-0 max-vh-100 ps-5 pe-5 pb-5 pt-3 w-100">
                ...
                <div class="container">
                    ...
                    {{-- Title --}}
                    <p class="h3-text font-yellow-dark4 p-semi-bold">Tambah Soal Studi Kasus</p>
                    ...
                    <form method="POST" enctype="multipart/form-data" action={{ route('admin.cs.store') }}>
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="question_type" name="question_type">
                                <option disabled selected>Pilih Tingkat Soal</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="instruction_count" name="instruction_count">
                                <option disabled selected>Pilih Jumlah Instruksi</option>
                                @for ($i = 1; $i <= 10; $i++)
                        ...
                        @for ($i = 1; $i <= 10; $i++)
                            <div class="mb-2">
                                ...
                                <textarea id="instruction_{{$i}}" name="instruction_{{$i}}"></textarea>
                            </div>
                            <div class="mb-4">
                                <label for="key_answer_{{$i}}" class="form-label fw-semibold">Kunci Jawaban {{ $i }}</label>
                                <textarea id="key_answer_{{$i}}" name="key_answer_{{$i}}"></textarea>
                            </div>
                        @endfor
