...
<html>
    <head>
        ...
        <title>Admin Simulasi CGAA | Tambah Soal Esai</title>
        <!-- Bootstrap CSS -->
        ...
        <div class="d-flex">
            ...
            <main class="d-flex flex-column overflow-auto border-0 max-vh-100 ps-5 pe-5 pb-5 pt-3 w-100">
                ...
                <div class="container">
                    ...
                    {{-- Title --}}
                    <p class="h3-text font-yellow-dark4 p-semi-bold">Tambah Soal Esai</p>
                    ...
                    <form method="POST" enctype="multipart/form-data" action={{ route('admin.ey.store') }}>
                        @csrf
            
                        {{-- Question Input --}}
                        <div class="mb-3">
                            <label for="question" class="form-label fw-semibold">Soal</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="correct_answer" name="correct_answer"></textarea>
                        </div>
