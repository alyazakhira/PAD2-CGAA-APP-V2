...
<html lang="en">
    <head>
        ...
        <title>Admin Simulasi CGAA | Detail Soal Esai</title>
        <!-- Bootstrap CSS -->
        ...
        <main class="d-flex flex-column max-vh-100 ps-5 pe-5 pb-5 pt-3 w-100">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex border-bottom border-dark justify-content-between h3-text p-medium mb-4">
                    <p class="mb-1 d-none d-lg-block"> ID Soal: {{ $ey->id }}</p>
                </div>
                
                {{-- Question --}}
                <div class="d-flex flex-column mb-3">
                    <div class="h4-text mb-3">{!! $ey->question !!}</div>
                </div>

                {{-- Explanation --}}
                <div class="d-flex flex-column border border-black rounded-1 p-3 my-3">
                    <p class="h4-text p-semi-bold">Penjelasan Soal</p>
                    <div class="d-flex flex-column mb-2">{!! $ey->correct_answer !!}</div>
                </div>
                ...
                <div class="d-grid gap-2">
                    <a href="{{ route('admin.ey.edit', $ey->id) }}" type="button" class="btn btn-blue-dark"><i class="bi bi-pencil-fill me-3"></i>Ubah Soal Ini</a>
                    <form class="d-grid" action="{{route('admin.ey.delete', $ey->id) }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-danger"><i class="bi bi-trash3-fill me-3"></i>Hapus Soal Ini</button>
                    </form>
                    <a href="{{ route('admin.ey.create') }}" type="button" class="btn btn-success"><i class="bi bi-file-earmark-plus-fill me-3"></i>Tambah Soal Baru</a>
                </div>
            </div>
        </main>
