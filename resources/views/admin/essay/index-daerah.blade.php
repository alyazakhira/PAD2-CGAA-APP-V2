...
<html>
    <head>
        ...
        <title>Admin Simulasi CGAA | Daftar Esai Daerah</title>
            ...
            <main  class="d-flex flex-column max-vh-100 ps-5 pe-5 pb-5 pt-3 w-100">
                ...
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between my-3">
                        <div class="h3-text font-yellow-dark4 p-semi-bold">Daftar Soal Esai Tingkat Daerah</div>
                        <a type="button" class="btn btn-blue-dark" href="{{ route('admin.ey.create') }}">+  Tambah Soal</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-nowrap">
                                                <a href="{{ route('admin.ey.edit', $q->id) }}" class="btn btn-outline-blue-dark" type="button">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <a href="{{ route('admin.ey.show', $q->id) }}" class="btn btn-outline-blue-dark mx-1" type="button">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <form style="width: fit-content" method="POST" action={{ route('admin.ey.delete', $q->id) }}>
                                                    @csrf
