...
<html>
    <head>
        ...
        <title>Admin Simulasi CGAA | Daftar Pilihan Ganda Daerah</title>
            ...
            <main  class="d-flex flex-column max-vh-100 ps-5 pe-5 pb-5 pt-3 w-100">
                ...
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between my-3">
                        <div class="h3-text font-yellow-dark4 p-semi-bold">Daftar Soal Pilihan Ganda Tingkat Daerah</div>
                        ...
                        @if (isset($content->current_page))
                            ...
                            @if (($content->next_page_url != null) && ($content->prev_page_url == null))
                                ...
                                @for ($i = 1; $i < ($content->last_page)+1; $i++)
                                    <li class="page-item"><a class="page-link" href="{{ route('admin.mp.index.daerah',$i) }}">{{ $i }}</a></li>
                                @endfor
                                <li class="page-item">
                                    <a class="page-link" href="{{ route('admin.mp.index.daerah',$next) }}">Next</a>
                                </li>
                            @elseif (($content->next_page_url == null) && ($content->prev_page_url != null))
                                <li class="page-item">
                                    <a class="page-link" href="{{ route('admin.mp.index.daerah',$prev) }}">Previous</a>
                                </li>
                                @for ($i = 1; $i < ($content->last_page)+1; $i++)
                                    <li class="page-item"><a class="page-link" href="{{ route('admin.mp.index.daerah',$i) }}">{{ $i }}</a></li>
                                @endfor
