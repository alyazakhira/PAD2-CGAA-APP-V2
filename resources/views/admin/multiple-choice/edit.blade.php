...
<html>
    <head>
        ...
        <title>Admin Simulasi CGAA | Ubah Soal</title>
        <!-- Bootstrap CSS -->
        ...
        <div class="d-flex">
            ...
            <main class="d-flex flex-column overflow-auto border-0 max-vh-100 ps-5 pe-5 pb-5 pt-3 w-100">
                ...
                <div class="container">
                    ...
                    <form method="POST" enctype="multipart/form-data" action={{ route('admin.mp.update', $mp->id) }}>
                        @csrf

                        {{-- Question Input --}}
                        <div class="mb-3">
                            <label for="pertanyaan" class="form-label fw-semibold">Pertanyaan</label>
                            <textarea name="question" id="question">{{ $mp->question }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="kunci-jawaban" class="form-label fw-semibold">Kunci Jawaban</label>
                            <select class="form-select" id="kunci-jawaban" name="correct_answer">
                                @if ($mp->correct_answer == "a")
                                    <option>Pilih jawaban yang tepat</option>
                                    <option value="a" selected>A</option>
                                    <option value="b">B</option>
                                    <option value="c">C</option>
                                    <option value="d">D</option>
                                @elseif ($mp->correct_answer == "b")
                                    <option>Pilih jawaban yang tepat</option>
                                    <option value="a">A</option>
                                    <option value="b" selected>B</option>
                                    <option value="c">C</option>
                                    <option value="d">D</option>
                                @elseif($mp->correct_answer == "c")
                                    <option>Pilih jawaban yang tepat</option>
                                    <option value="a">A</option>
                                    <option value="b">B</option>
                                    <option value="c" selected>C</option>
                                    <option value="d">D</option>
                                @elseif($mp->correct_answer == "d")
                                    <option>Pilih jawaban yang tepat</option>
                                    <option value="a">A</option>
                                    <option value="b">B</option>
                                    <option value="c">C</option>
                        ...
                        <div class="mb-3">
                            <label for="penjelasan" class="form-label fw-semibold">Penjelasan</label>
                            <textarea id="question_explanation" name="question_explanation">{{ $mp->question_explanation }}</textarea>
                        </div>
