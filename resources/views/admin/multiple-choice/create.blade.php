...
<html>
    <head>
        ...
        <title>Admin Simulasi CGAA | Tambah Soal Pilihan Ganda</title>
        <!-- Bootstrap CSS -->
        ...
        <div class="d-flex">
            ...
            <main class="d-flex flex-column overflow-auto border-0 max-vh-100 ps-5 pe-5 pb-5 pt-3 w-100">
                ...
                <div class="container">
                    ...
                    {{-- Title --}}
                    <p class="h3-text font-yellow-dark4 p-semi-bold">Tambah Soal Pilihan Ganda</p>
                    ...
                    <form method="POST" enctype="multipart/form-data" action={{ route('admin.mp.store') }}>
                        @csrf
